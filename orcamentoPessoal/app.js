...
function cadastrarDespesa() {
    ...
    if(despesa.validarDados()){
        bd.gravar(despesa)
        document.getElementById('modalTitulo').innerHTML = 'Registro gravado com sucesso'
        ...
        document.getElementById('modalConteudo').innerHTML = 'Erro no cadastro da despesa, verifique se os campos foram preenchidos corretamente!'
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    if(despesas.length == 0 && filtro == fale) {
